...
<head>
<title>Äänestyskone - Vaalikone kansanedustajien todellisista valinnoista</title>
...
<div id="share">
<h4>Miten tämä toimii?</h4>
<p>Palvelun pohjana olevat äänetystulokset on haettu eduskunnan www-sivuilta epävirallisen <a href="http://www.biomi.org/eduskunta/eduskunta.html">eduskuntarajapinnan</a> avulla. Palvelun tekeminen olisi ollut paljon helpompaa, jos eduskunta itse tarjoaisi äänestystulokset ja muut tiedot avoimesti. Voit edistää tätä äänestämällä ehdokasta, joka ottaa tietoyhteiskunta-asiat tosissaan!</p>

<h4>Jaa tämä sivu Facebookissa</h4>
...
<p>Tämän "äänestyskoneen" avulla voit verrata kansanedustajien äänestysvalintoja omiin mielipiteisiisi. Kun valitset miten olisit itse äänestänyt ao. äänestyksissä, kone vertaa valintojasi kansanedustajiin ja esittää heidät sopivuusjärjestyksessä. Mukaan on otettu valikoima tunnettuja ja keskustelua herättäneitä äänestyksiä 2000-luvulta, painottaen tuoreempia äänestyksiä.</p>
...
<p>Äänestystulokset on haettu Eduskunnan verkkosivuilta <a href="http://www.biomi.org/eduskunta/eduskunta.html">äänestysrajapinnan</a> avulla.</p>


<?php

// 2010
$aanestykset['a1_107-2010'][0] = "Hallituksen esitys laiksi <strong>ampuma-aselain muuttamisesta</strong> sekä kansainvälisen järjestäytyneen rikollisuuden vastaisen Yhdistyneiden Kansakuntien yleissopimuksen lisäpöytäkirjan hyväksymisestä";
...
$aanestykset['a4_119-2009'][0] = "Hallituksen esitys <strong>laiksi sidotusta pitkäaikaissäästämisestä</strong> ja eräiksi siihen liittyviksi laeiksi";
